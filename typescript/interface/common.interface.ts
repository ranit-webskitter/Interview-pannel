export enum HttpStatusCode {
  ...
  export interface IUserProfileAddressBody {
    title: string;
  ...
  export interface IUserProfileUpdateAddressBody {
    id: string;
    title: string;
    addressline_1: string;
    addressline_2: string;
  ...
  export interface IProductListBody {
    id: string;
    page: string;
    limit: string;
  }
  
  export interface IUserAddCardBody {
    card_name: string;
    card_number: string;
    expiry_date: string;
  }
  export interface IUserEditCardBody {
    id: string;
    card_name: string;
    card_number: string;
    expiry_date: string;
